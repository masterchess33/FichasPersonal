...
namespace SistemaWeb.Migrations
{
    ...
    [Migration("20220201205945_InitialCreate")]
            ...
            modelBuilder.Entity("SistemaWeb.Model.Empleado", b =>
                {
                    ...
                    b.Property<int?>("DireccionEmpleadoDireccionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DireccionEmpleadoDireccionId");
            ...
            modelBuilder.Entity("SistemaWeb.Model.Empleado", b =>
                {
                    ...
                    b.HasOne("SistemaWeb.Model.Direccion", "DireccionEmpleado")
                        .WithMany("Empleados")
                        .HasForeignKey("DireccionEmpleadoDireccionId");

                    b.Navigation("Cargo");

                    b.Navigation("Departamento");

                    b.Navigation("DireccionEmpleado");
                });

            modelBuilder.Entity("SistemaWeb.Model.Sucursal", b =>
                {
                    b.HasOne("SistemaWeb.Model.Direccion", "DireccionSucursal")
                        .WithOne("Sucursal")
                        .HasForeignKey("SistemaWeb.Model.Sucursal", "DireccionId");

                    b.Navigation("DireccionSucursal");
                });
